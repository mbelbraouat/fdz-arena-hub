      ...
      <div className="container mx-auto px-6">
        <div className="flex items-center justify-between h-20">
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <span className="font-heading text-2xl font-bold text-foreground">FDZ</span>
          </Link>
          ...
          <div className="hidden md:flex items-center gap-4">
            <Link to="/registration">
              <Button variant="default" size="lg">Register Team</Button>
            </Link>
          </div>
          ...
          >
            <div className="container mx-auto px-6 py-6 space-y-4">
              ...
              <Link to="/registration" onClick={() => setIsOpen(false)}>
                <Button variant="default" className="w-full mt-4">Register Team</Button>
              </Link>
            </div>
          </motion.div>
        )}
